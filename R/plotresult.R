...
rxmu_plot <- function(rxmo=-2,rxy=-2,rymo=-2,rmomu=-2,rymu=-2, nobs=0, labelest = "indirect1", conflevel=0.95){
  ...
  if (labelest == "indirect1") {
    ...
    figure <- ggplot2::ggplot(result_ind1, ggplot2::aes_string(x='rxmu', y='est'))+
      ...
      ggplot2::labs(y="Estimate and confidence interval for indirect effect")
  }
  if (labelest == "a1") {
    ...
    figure <- ggplot2::ggplot(result_a1, ggplot2::aes_string(x='rxmu', y='est'))+
      ...
      ggplot2::labs(y="Estimate and confidence interval for a")
  }
  if (labelest == "b1") {
    ...
    figure <- ggplot2::ggplot(result_b1, ggplot2::aes_string(x='rxmu', y='est'))+
      ...
      ggplot2::labs(y="Estimate and confidence interval for b")
  }
  if (labelest == "c") {
    ...
    figure <- ggplot2::ggplot(result_c, ggplot2::aes_string(x='rxmu', y='est'))+
      ...
      ggplot2::labs(y="Estimate and confidence interval for direct effect")
  }
  return(figure)
}
